all:
	...
	javac -Xlint:deprecation -d build/classes src/main/java//kx/Connection.java src/main/java//kx/examples/Feed.java src/main/java//kx/examples/QueryResponse.java src/main/java//kx/examples/Subscriber.java src/main/java//kx/examples/Server.java src/main/java//kx/examples/TypesMapping.java src/main/java//kx/examples/GridViewer.java
#	jar cf build/Connection.jar build/kx/*.class
doc:
	javadoc -d docs src/main/java//kx/Connection.java
Feed:
